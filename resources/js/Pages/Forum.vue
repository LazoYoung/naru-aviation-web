        ...
        <div class="max-w-7xl mx-auto py-12 sm:px-6">
            <div class="p-6 bg-white shadow-sm sm:rounded-lg">
                <div class="h-12 flex gap-x-4">
                    <select class="font-semibold" name="categories" id="category">
            ...
            <div class="mt-12 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <table class="w-full">
                    <tbody>
                        <PostRow title="Hello, world!" category="General" color="#000000" author="Chanyoung Park" :date="new Date(2023, 4, 26, 18, 22)" :view.number="13"></PostRow>
                    </tbody>
                </table>
            </div>
        </div>
